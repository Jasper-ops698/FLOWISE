...
declare class MomentoRPCMethodMetadataConverter {
    private static readonly rpcMethodToMetadataMap;
    /**
     ...
     */
    static convert(rpcMethod: string): string;
}
